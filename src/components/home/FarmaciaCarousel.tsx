...
const images = [
  '/images/farmacia/MAD_0604.jpg',
  '/images/farmacia/MAD_0628.jpg',
  '/images/farmacia/MAD_0630.jpg',
  '/images/farmacia/MAD_0633.jpg',
  '/images/farmacia/MAD_0812.jpg',
];

export default function FarmaciaCarousel() {
    ...
    <div className="relative w-full h-[400px] md:h-[500px] rounded-xl overflow-hidden shadow-lg group">
      ...
      {images.map((image, index) => (
        ...
        >
          <Image
            src={image}
            alt={`Farmacia Resta - Foto ${index + 1}`}
            fill
